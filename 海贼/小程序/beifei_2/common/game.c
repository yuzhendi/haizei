...
void initfootball() {
    ...
    Football = create_newwin(court.width, court.heigth, court.start.x, court.start.y) ;  // 大的窗口        
    Football_t = subwin(Football, court.width - 4, court.heigth - 2, court.start.x + 2, court.start.y + 1) ;  //子窗口          
    box(Football_t, 0, 0);
    wrefresh(Football_t);
